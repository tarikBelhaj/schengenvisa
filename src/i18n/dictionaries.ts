...
const fr = {
  ...
  pets: {
    ...
    titerTitle: 'Comprendre le titrage antirabique',
    titerBody: 'Le titrage (RNATT ou FAVN) est une prise de sang qui mesure le taux d’anticorps contre la rage. Il se fait au moins 30 jours après la vaccination, dans un laboratoire agréé, et le résultat doit atteindre 0,5 UI/ml. Ce n’est pas un vaccin : c’est la preuve que le vaccin a fonctionné.',
    titerOman: 'Oman applique ensuite une règle des 3 mois : 90 jours doivent s’écouler entre la prise de sang et l’entrée sur le territoire. C’est ce délai, et non le vaccin lui-même, qui détermine la date de départ la plus proche.',
    titerRabiesDate: 'Vaccination antirabique du {date}',
    docDated: 'Document du {date}',
    docUntil: 'valide jusqu’au {date}',
...
const en: Dict = {
  ...
  pets: {
    ...
    titerTitle: 'Understanding the rabies titer test',
    titerBody: 'The titer test (RNATT or FAVN) is a blood sample measuring rabies antibody levels. It is taken at least 30 days after vaccination, in an approved laboratory, and the result must reach 0.5 IU/ml. It is not a vaccine: it is proof the vaccine worked.',
    titerOman: 'Oman then applies a 3-month rule: 90 days must pass between the blood sample and entry into the country. That waiting period, not the vaccine itself, sets the earliest possible departure date.',
    titerRabiesDate: 'Rabies vaccination of {date}',
    docDated: 'Document dated {date}',
    docUntil: 'valid until {date}',
